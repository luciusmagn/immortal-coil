...
- Fanning is fine when it is consequence, not crossroads: variants keyed to the player's own earlier choices inside the same path may branch freely. Variants keyed to other paths' flags must stay rare, single, and woven into existing beats.
